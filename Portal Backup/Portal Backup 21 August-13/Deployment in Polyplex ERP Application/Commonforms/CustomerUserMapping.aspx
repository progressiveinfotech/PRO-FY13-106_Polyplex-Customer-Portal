<%@ Page Title="Final Destination" Language="C#" MasterPageFile="~/Masters/EmptyMaster.master"
    AutoEventWireup="true" CodeFile="CustomerUserMapping.aspx.cs" Inherits="Sales_MasterFinalDestination" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:Panel ID="Panel1" runat="server">
                ...
                <table width="100%" cellpadding="3px">
                                ...
                                <asp:Panel ID="Panel2" runat="server">
                                    <asp:GridView ID="gvMapping" runat="server" AllowPaging="True" PageSize="5" EmptyDataText="No Records Found."
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="UserCode" HeaderText="User Code"></asp:BoundField>
                                            <asp:BoundField DataField="UserName" HeaderText="User Name"></asp:BoundField>
                                            <asp:BoundField DataField="Type" HeaderText="User Type"></asp:BoundField>
                                            <asp:BoundField DataField="CustomerGroup" HeaderText="Customer Group"></asp:BoundField>
                                            <asp:BoundField DataField="CustomerCode" HeaderText="Customer Code"></asp:BoundField>
                                            <asp:BoundField DataField="Name" HeaderText="Customer Name"></asp:BoundField>
                    ...
                    <tr>
                        <td width="35%">
                            <div align="right">
                                <asp:Label runat="server" Text="User Code:" ID="Label1"></asp:Label>
                                <span style="color: Red; font-weight: bold">*</span></div>
                        </td>
                        <td width="50%">
                            <div align="left">
                                <asp:TextBox runat="server" Width="200px" ID="txtUserCode" AutoPostBack="True" OnTextChanged="txtUserCode_TextChanged"></asp:TextBox>
                                <asp:ImageButton ID="imgBtnUserCode" runat="server" Height="16px" ImageUrl="~/images/select.gif"
                                    CausesValidation="False" OnClick="imgBtnUserCode_Click" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div align="right">
                                <asp:Label runat="server" Text="User Type:" ID="Label3"></asp:Label>
                            </div>
                        </td>
                        <td>
                            <div align="left">
                                <asp:TextBox ID="txtUserType" runat="server" Width="200px" CssClass="txtbox"></asp:TextBox>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div align="right">
                                <asp:Label runat="server" Text="Customer Group:" ID="Label4"></asp:Label>
                                <span style="color: Red; font-weight: bold">*</span></div>
                        </td>
                        <td>
                            <div align="left">
                                <asp:TextBox runat="server" Width="200px" ID="txtCustomerGroup" AutoPostBack="True"
                                    OnTextChanged="txtCustomerGroup_TextChanged"></asp:TextBox>
                                <asp:ImageButton ID="imgBtnCustomerGroup" runat="server" Height="16px" ImageUrl="~/images/select.gif"
                                    CausesValidation="False" OnClick="imgBtnCustomerGroup_Click" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                ...
                <div>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="1" runat="server"
                        ErrorMessage="User Code is mandatory." Display="None" ControlToValidate="txtUserCode"
    ...
    <div>
        ...
        <asp:HiddenField ID="HidCustomerGroupId" runat="server" />
